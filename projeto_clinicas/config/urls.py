...
urlpatterns = [
    ...
    path(".well-known/assetlinks.json", core_views.asset_links_json, name="asset-links"),
    path("app-android/baixar/", core_views.download_android_app, name="android-app-download"),
